...
export const getStyles = (theme) => {
  ...
  return StyleSheet.create({
    ...
    unitToggleContainer: { flexDirection: "row", backgroundColor: c.border, borderRadius: 8, padding: 2 },
    unitToggleBtn: { paddingVertical: 8, paddingHorizontal: 12, borderRadius: 6, backgroundColor: "transparent" },
    unitToggleBtnActive: { backgroundColor: c.primary },
    // Day Picker
    dayPickerRow: {
      flexDirection: "row",
      justifyContent: "space-between",
    ...
    dayPickerCircleActive: {
      backgroundColor: c.dayPickerActive,
    ...
    datePickerText: { color: c.textMain, fontSize: 15 },
    ...
    doseAmountInput: {
      // Assuming you have a base input style, just adding the layout specifics
      backgroundColor: c.inputBg,
      borderRadius: 8,
      color: c.textMain,
      padding: 12,
    ...
    cancelText: { color: c.textSub, fontWeight: "bold" },
